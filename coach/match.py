...
class Match():
    ...
    def __init__(self,nom,vision,grSim,com,controlledTeams='B',blueSide='L',start='B',disp=0):
        ...
        if blueSide=='L':
            ...
            yellowSide='L'
        Yellow=coach.Coach([self.joueurs[0],self.joueurs[1]],'Y',yellowSide,self)
        Blue=coach.Coach([self.joueurs[2],self.joueurs[3]],'B',blueSide,self)
    ...
    def UpStrategy(self):
        if self.strategie == 'NORMAL':
            self.strategie = 'OFFENSIF'
            print('OFFENSIF')
            
        elif self.strategie == 'DEFENSIF':
            self.strategie = 'NORMAL'
            print('NORMAL')
        
    def DownStrategy(self):
        if self.strategie == 'NORMAL':
            self.strategie = 'DEFENSIF'
            print('DEFENSIF')
            
        elif self.strategie == 'OFFENSIF':
            self.strategie = 'NORMAL'
            print('NORMAL')
