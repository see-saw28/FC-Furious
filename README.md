...
On observe effectivement que la fonction Loss function square(h<sub>&theta;</sub>(x) = &theta;<sub>o</sub> x + &theta;<sub>1</sub>x) diminue bien sur le graphique du bas.  
